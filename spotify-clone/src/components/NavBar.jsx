    ...
    <>
        <div className='w-full flex justify-between items-center font-semibold'>
            <div className='flex items-center gap-2'>
                <img src={assets.arrow_left} className='w-8 p-2 rounded-2x1 cursor-pointer' alt=""></img>
                <img src={assets.arrow_right} className='w-8 p-2 rounded-2x1 cursor-pointer' alt=""></img>
            </div>
